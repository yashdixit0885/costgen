...
**Tests**: Per Constitution Principle IV (Test-First, NON-NEGOTIABLE), tests are MANDATORY. Write them first, ensure they FAIL before implementation, and hold cost-math modules to 100% coverage.
